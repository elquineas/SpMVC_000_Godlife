document.addEventListener("DOMContentLoaded", () => {
  ...
  const form_cinput =
    document.querySelector("form.main.cinput") ||
    document.querySelector("form.main.coinput") ||
    document.querySelector("form.main.update");

  const cinput_code = form_cinput?.querySelector("input[name='c_code']");
  ...
  const btn_cinput =
    document.querySelector("button.cinput") ||
    document.querySelector("button.coinput");
  ...
  btn_cinput?.addEventListener("click", cinputButtonClickHandler);
});
